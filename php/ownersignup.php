...
if ($firstname==""|| $lastname=="" || $username=="" || $email=="" || $password=="") {
    ...
    if ($num > 0) {
      ...
      $existsSql= "Select * from owner_info where aadhar='$aadhar'";
      $result= mysqli_query($conn,$existsSql);
      $num = mysqli_num_rows($result);
      if ($num > 0) {
        $err_ad = true;
        ...
        if ($password==$cpass) {
          ...
          $sql = "INSERT INTO `owner_info` (`firstname`, `lastname`, `username`, `email`, `aadhar`, `mobile`, `address`, `pass`, `date`) VALUES ('$firstname', '$lastname', '$username', '$email', '$aadhar', '$mobile', '$address', '$hash', current_timestamp())";
...
<html lang="en">
  ...
  <body>
    <div class="container w-100 justify-content-center d-flex d-inline-flex p-2">
      <h1 class="text-white">Wellcome To Lokation </h1><br><br><hr>
      
    <h2 class="text-white">First step towards ease!!!</h2>
    </div> <br>
  ...
  <div class="col-md-6 mt-0">
    ...
    <input type="text" class="form-control" id="validationCustom05" name="aadhar" minlength="10" maxlength="10" placeholder="Enter Your Aadhar No" required>
    <div class="valid-feedback">
    </div>
  </div>
  <div class="col-md-12 mt-3">
    <label for="validationCustom03" class="form-label">Address/Landmark</label>
