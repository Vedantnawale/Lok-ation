...
<a href="user_login.php" class="btn btn-primary active">Login</a> 
<a href="user_signup.php" class="btn btn-primary" aria-current="page">Signup</a>
</div>';
include "db.php";
...
<?php
  ...
  <div class="container w-100 justify-content-center d-flex d-inline-flex p-2">
    <h1 class="text-white">Fill the details properly</h1>
  </div>
  <div class="container cm  w-100 d-flex d-inline-flex p-2">
    <form action="user_login.php" method="post" class="row g-3 needs-validation" novalidate>
